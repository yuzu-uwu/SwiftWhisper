...
public class Whisper {
    ...
    public init(path: String, withParams params: WhisperParams = .default) {
        var default_params = whisper_context_default_params()
#if targetEnvironment(simulator)
        default_params.use_gpu = false
        print("Running on the simulator, using CPU")
#endif
        self.whisperContext = whisper_init_from_file_with_params(path, default_params)
        self.params = params
    }
